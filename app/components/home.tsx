      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        <div className="flex flex-col md:flex-row md:justify-between mb-8">
          ...
          <div className="md:w-2/3 md:pl-8">
            <div className="bg-white dark:bg-gray-800 bg-opacity-80 dark:bg-opacity-80 p-6 rounded-lg shadow-lg">
        ...
        {/* Skills Container */}
        <div className="w-full max-w-6xl mx-auto p-6 rounded-lg bg-white dark:bg-gray-800 bg-opacity-80 dark:bg-opacity-80 shadow-lg">
